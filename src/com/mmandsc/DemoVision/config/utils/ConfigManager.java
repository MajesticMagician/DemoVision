package com.mmandsc.DemoVision.config.utils;
...
public class ConfigManager {
	...
	public ConfigManager(Player p) {
		this.u = p.getDisplayName();

		configs.add(this);
	}
	
	public ConfigManager(String u) {
		this.u = u;
	 ...
	 */
	public static ConfigManager getConfig1(Player u) {
		for (ConfigManager c : configs) {
